...
# HWork
# cantryes = ['Russia', 'Italia', 'Shweden', 'USA']
# print(cantryes)
# uzunligi = len(cantryes)
# print(uzunligi)
# print(sorted(cantryes))
# print(sorted(cantryes, reverse=True))
# print(cantryes)
# cantryes.reverse()
# print(cantryes)
# cantryes.sort()
# print(cantryes)
# cantryes.sort(reverse=True)
# print(cantryes)
...
# summ = len(numbers)
# print(numbers[:20])
# print(numbers[240:260])
# print(numbers[-20:])

taomlar = ['osh', 'shashlik', 'barak', 'manti', 'borsh']
nonushta = taomlar[0:]
nonushta.remove('osh')
