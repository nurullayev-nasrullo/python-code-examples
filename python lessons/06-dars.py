...
# s_kvad = number **2
# s_kub = number **3
# print(f'{number} ning kvadrati {s_kvad} ga teng')
# print(f'{number} ning kubi {s_kub} ga teng')

# yosh = int(input("Yoshingiz nechida? "))
# t_yil = 2023 - yosh
# print(f'Siz {t_yil} yilda tug`ilgansiz')

f_son = float(input("Birinchi sonni kiriting: "))
f_ikson = float(input("Ikkinchi sonni kiriting: "))
print(f'{f_son} + {f_ikson} = {f_son + f_ikson}')
print(f'{f_son} - {f_ikson} = {f_son - f_ikson}')
print(f'{f_son} * {f_ikson} = {f_son * f_ikson}')
print(f'{f_son} / {f_ikson} = {f_son / f_ikson}')
