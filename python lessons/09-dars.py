...
# HWork
# ismlar = ['shodiyor', 'rustam', 'jamshid', 'jurabek', 'asad']
# n = 0
# for ism in ismlar:
#     print(f'{ism} ishlar yaxshimi?')
#     n+=1
...
# favorit_moves = []
# for move in range(5):
#     favorit_moves.append(input(f'{move+1} - eng sevimli kinolaringizni kiriting: '))

# print(favorit_moves)

# nameMeet = []
# meet = int(input('Bugun nechta odam bilan uchrashdiz: '))
# # for m in range(meet):
#     nameMeet.append(input(f'{m+1} - odamni ismini kiriting: '))
